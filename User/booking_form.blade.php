    ...
    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
        ...
        <div class="card card-bordered">
            <div class="card-inner card-inner-lg">
                ...
                <form id="reservation-form" method="POST" action="{{ route('outside_booking/save') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        <div class="form-label-group">
                            <label for="nightstay" class="form-label">Select type</label>
                        </div>
                        <div class="form-control-wrap col-md-6 mb-1">
                            <div class="custom-control custom-radio checked">
                                <input type="radio" id="nightstay" name="bookingtype" class="custom-control-input" value="Night Stay" checked>
                                <label class="custom-control-label" for="nightstay">Night Stay</label>
                            </div>
                        </div>

                        <div class="form-control-wrap col-md-6 mb-1">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="daystay" name="bookingtype" class="custom-control-input" value="Day Stay">
                                <label class="custom-control-label" for="daystay">Day Stay</label>
                            </div>
                        </div>
                    ...
                    <div class="" id="show_booking_area" style="display: none">
                    <div class="form-group row">
                        <div class="form-label-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" id="f_name" name="f_name" class="form-control" placeholder="Enter your first name" required autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" id="l_name" name="l_name" class="form-control" placeholder="Enter your last name" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select id="booking_method" name="booking_method" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" id="passport_number" name="passport_number" class="form-control" placeholder="Enter your passport number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="tel" id="whatsapp_number" name="whatsapp_number" class="form-control" placeholder="Enter your WhatsApp number (include country code)" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="number" id="adults" name="adults" class="form-control" min="1" max="100" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="number" id="children" name="children" class="form-control" min="0" max="100" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <div class="form-file">
                                <input type="file" multiple class="form-file-input" id="image" name="image" required>
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <label for="advanced_payment" class="form-label">Advance Payment</label>
                            </div>
                            <div class="form-control-wrap">
                                <input type="number" id="advanced_payment" name="advanced_payment" class="form-control" required>
                            </div>
                        </div>
                    <div class="form-group row">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap col-md-6 mb-1">
                            <div class="custom-control custom-radio checked">
                                <input type="radio" id="customRadio3" name="Breakfast" class="custom-control-input" value="No Meal" checked>
                                <label class="custom-control-label" for="customRadio3">No Meal</label>
                            </div>
                        </div>
                        <div class="form-control-wrap col-md-6 mb-1">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="Breakfast" class="custom-control-input" value="Breakfast">
                                <label class="custom-control-label" for="customRadio1">Breakfast</label>
                            </div>
                        </div>
                        <div class="form-control-wrap  col-md-6 mb-1">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="Breakfast" class="custom-control-input" value="Half Board" >
                                <label class="custom-control-label" for="customRadio2">Half Board</label>
                            </div>
                        </div>
                        <div class="form-control-wrap  col-md-6 mb-1">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio4" name="Breakfast" class="custom-control-input" value="Full Board" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <textarea id="note" name="note" class="form-control" placeholder="Enter any special requests, such as dietary restrictions (vegan, gluten-free), preferred breakfast time, or beverage preferences (tea, coffee)"></textarea>
                        </div>
                    </div>
...
{{--                $.ajax({--}}
{{--                    type: 'POST',--}}
{{--                    url: '{{ route('outside_booking/booking/get_available_rooms_details',[$hotel_id]) }}',--}}
    ...
    $(function() {
        ...
        function initializeDatePicker() {
            currentPicker = $('input[name="daterange"]').daterangepicker({
                ...
                $('#check_in_date').val(selected_date);
                console.log('Day stay on ' + selected_date);
                get_avilable_rooms(selected_date,selected_date,'Day Stay');
            });
        }

        // Initialize the date range picker by default
        initializeDateRangePicker();

        // Listen for changes in the booking type radio buttons
        $('input[name="bookingtype"]').change(function() {
            var selectedValue = $(this).val();
            if (selectedValue === 'Day Stay') {
                // If Day Stay is selected, change the input type to date picker
                if (currentPicker) {
                    currentPicker.data('daterangepicker').remove();
                    currentPicker = null;
                }
                initializeDatePicker();
            } else if (selectedValue === 'Night Stay') {
                // If Night Stay is selected, change the input type back to date range picker
                if (currentPicker) {
                    currentPicker.data('daterangepicker').remove();
                    currentPicker = null;
                }
        ...
        function get_avilable_rooms(checking_date,checkout_date,stay) {
            $.ajax({
                type: 'POST',
                url: '{{ route('outside_booking/booking/get_available_rooms_details',[$hotel_id]) }}',
                headers: {'X-CSRF-TOKEN': '{{csrf_token()}}'},
                ...
                success: function (data) {
                    ...
                    $.each(data.availableRoomCounts, function (key2, val2) {
                        ...
                        console.log(val2.category.id);
                        console.log(val2.category.id);
                        for (var i = 0; i <= val2.available_counts; i++) {
                            // console.log('xxxxx');
                            // console.log(val2.available_count);
                            room_counts += '<option value="' + i + '">' + i + '</option>\n';
                        }
                        room_counts += '</select></span></li>';
                    });
